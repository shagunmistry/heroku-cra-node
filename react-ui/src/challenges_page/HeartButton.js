...
class HeartButton extends Component {
    ...
    /**
     * Check if the user is logged in, see if he/she has already voted on this challenge.
     */
    componentWillMount() {
        var referThis = this, challengedUniqueKey = referThis.props.challengedUniqueKey,
            challengeruserid = referThis.props.challengeruserid, challengerUniqueKey = referThis.props.challengerUniqueKey;

        //check if the user has already logged in and color the button if he/she has
